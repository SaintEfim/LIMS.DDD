...
namespace LIMS.DDD.Service.Persistence.Migrations
{
    ...
    [Migration("20260816075303_Link_resultDefinitin_and_unit")]
    partial class Link_resultDefinitin_and_unit
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("LIMS.DDD.Service.Domain.LaboratoryOperationsContext.StudyAggregate.ValueObjects.ParameterSnapshot", "ParameterSnapshot", b1 =>
                        {
                            ...
                            b1.OwnsOne("LIMS.DDD.Service.Domain.SeedWork.ValueObjects.Specification", "Specification", b2 =>
                                {
                                    b2.Property<Guid>("ParameterSnapshotMeasuredValueId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ParameterSnapshotMeasuredValueId");

                                    b2.ToTable("MeasuredValues");

                                    b2.WithOwner()
                                        .HasForeignKey("ParameterSnapshotMeasuredValueId");
                                });

                            b1.Navigation("Specification")
                                .IsRequired();
                        });
                    ...
                    b.OwnsOne("LIMS.DDD.Service.Domain.LaboratoryOperationsContext.StudyAggregate.ValueObjects.ResultSnapshot", "ResultSnapshot", b1 =>
                        {
                            ...
                            b1.OwnsOne("LIMS.DDD.Service.Domain.SeedWork.ValueObjects.Specification", "Specification", b2 =>
                                {
                                    b2.Property<Guid>("ResultSnapshotTestResultId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ResultSnapshotTestResultId");

                                    b2.ToTable("TestResults");

                                    b2.WithOwner()
                                        .HasForeignKey("ResultSnapshotTestResultId");
                                });
